...
//    $query .= "ORDER BY year DESC, term DESC, slpe_id DESC";
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        Student Learning Plan &amp; Evaluation: Add New
                    </h1>
                </div>
            </div> <!-- /.row -->
            <?php
...
//                }
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <?php
                                    ...
                                    $date = date('Y/m/d');
                                ?>
                                <input type="hidden" name="slpe_id" id="slpe_id" value="" />
                                <input type="hidden" name="year" id="year" value="<?php echo $year; ?>" />
                                <input type="hidden" name="date" id="date" value="<?php echo $date; ?>" />
                                <div class="form-group">
                                    <label for="slpe_status">Status</label>
                                ...
                                <?php $tutor = $_SESSION['user_employee_id']; ?>
                                <input type="hidden" name="tutor" id="tutor" value="<?php echo $tutor; ?>" />
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input class="form-control" name="concept_hidden" id="concept_hidden" value="" readonly/> <!-- for learning_activity -->
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="comments_homework" id="comments_homework" rows="34"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group text-right">
                                    <a class="btn btn-default" name="academic_slpe_addnew_cancel" id="academic_slpe_addnew_cancel" href="slpes.php">Cancel</a>
                                    <input class="btn btn-success" type="submit" name="academic_slpe_addnew" id="academic_slpe_addnew" value="Add New" />
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <?php
                //----------Insert----------//
                if(isset($_POST['academic_slpe_addnew'])){
