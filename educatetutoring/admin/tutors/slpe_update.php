...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        Student Learning Plan &amp; Evaluation: Update
                    </h1>
                </div>
            </div> <!-- /.row -->
            <?php
            ...
            <div class="row">
                <div class="col-lg-12">
                    <form method="post" id="academic_slpe_insert_form">
                        <div class="row">
                            <div class="col-lg-6">
                                <input type="hidden" name="slpe_id" id="slpe_id" value="<?php echo $slpe_id; ?>" />
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group text-right">
                                    <a class="btn btn-default" name="academic_slpe_update_cancel" id="academic_slpe_update_cancel" href="slpes.php">Cancel</a>
                                    <input class="btn btn-success" type="submit" name="academic_slpe_update" id="academic_slpe_update" value="Update" />
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <?php
                //----------update----------//
                if(isset($_POST['academic_slpe_update'])){
